...
<!--                    <p>  --><?php //print($userRow['user_email']); ?><!--</p>-->
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="paymentsreport.php"><i class="fa fa-circle-o"></i>Payments</a></li>                      
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Get Report</a></li>
                <li class="active"></li>
                <form action="paymentsreport.php" method="post">
                    <input type="text" class="form-control" name="number"  placeholder="1"/>
                    <br>
                    <input type="text" class="form-control" name="status"  placeholder="completed"/> <br>
                    <input type="text" class="form-control" name="time"  placeholder="2017-01-04 08:05:10"/> <br>
                    <input name="submit" class="btn btn-success" type="submit" id="submit" value="Report" />
                </form>
            </ol>
<div id="cira">
             <?php
