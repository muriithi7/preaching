                  ...
                  <li class="mt">
                      <a  class="active" href="dashboard.php">
                          ...
                          <span>Users</span>
						   ...
						   <li><a  href="adminlog.php">Admins Logs</a></li>
...
mysqli_select_db($burec, $database_burec);
$query_Recordset2 = "SELECT * FROM tbl_users";
...
function GetSQLValueStrin($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  $theValue = (!get_magic_quotes_gpc()) ? addslashes($theValue) : $theValue;
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE registration SET province=%s, dob=%s, proffesion=%s, territory=%s, history=%s, phone=%s, id=%s, nation=%s, `level`=%s, address=%s, userID=%s WHERE place=%s",
                       GetSQLValueStrin($_POST['province'], "text"),
                       GetSQLValueStrin($_POST['dob'], "text"),
                       GetSQLValueStrin($_POST['proffesion'], "text"),
                       GetSQLValueStrin($_POST['territory'], "text"),
                       GetSQLValueStrin($_POST['history'], "text"),
                       GetSQLValueStrin($_POST['phone'], "text"),
                       GetSQLValueStrin($_POST['id'], "text"),
                       GetSQLValueStrin($_POST['nation'], "text"),
                       GetSQLValueStrin($_POST['level'], "text"),
                       GetSQLValueStrin($_POST['address'], "text"),
                       GetSQLValueStrin($_POST['userID'], "int"),
                       GetSQLValueStrin($_POST['place'], "text"));
...
mysqli_select_db($burec,$database_burec);
$query_Recordset1 = "SELECT * FROM registration where userID='".$row_Recordset2['userID']."'";
