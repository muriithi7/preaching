  ...
  <section id="container" >
     ...
     <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Accounts That Have Logged Into The System </h3>
          	<?php 
...
$sql = "SELECT * FROM adminlog where status='logged in' LIMIT {$startpoint} , {$limit}";
...
$sql = "SELECT * FROM adminlog where status='logged out' LIMIT {$startpoint} , {$limit}";
