...
<head>
    ...
    <title>Burec Administrator Account</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info"                 <p> <?php print($userRow['username']); ?></p>                    <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
                </div>
            </div>
            <!-- search form -->
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>Burec Territiry Administrator</span>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="admin1.php"><i class="fa fa-circle-o"></i>Approve Sign-up Member Request</p>  </a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-edit"></i> <span>View Members-Butembo Territory</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>   </a>
