...
<p align="right">
                        ...
                        <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal" name="btn-update" id="btn-update">ADD PRAYERS</button></p>
 ...
 <!--end of  new event button-->
                            ...
                            $stmt = $dbh->prepare("SELECT * FROM prayers ORDER BY prayer_id DESC");
                            $stmt->execute();
                            while($row=$stmt->fetch(PDO::FETCH_ASSOC))
                            {
                                ?>
                                <tr>
                                <td><?php echo $row['prayer_id']; ?></td>
                                <td><?php echo $row['about']; ?></td>
                                <td><?php echo $row['description']; ?></td>
                                <td><?php echo $row['prayer_type']; ?></td>
                                <td><?php echo $row['time']; ?></td>
                                <td><?php echo $row['user']; ?></td>
                                <td><?php echo $row['prayedby']; ?></td>
                                <td><?php echo $row['status']; ?></td>
                            
                                <td align="center">
                                <a id="<?php echo $row['prayer_id']; ?>" class="edit-link" href="#" title="Edit">
                                <img src="edit.png" width="20px" />
                                </a></td>
                                <td align="center"><a id="<?php echo $row['prayer_id']; ?>" class="delete-link" href="#" title="Delete">
...
<!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">PRAYERS DETAILS</h4>
        </div>
    ...
    <table class='table table-bordered table-responsive'>
        ...
        <tr>
            <td>About</td>
            <td><input type='text' name='about' class='form-control'  required></td>
        </tr>
        ...
        <tr>
            <td>Prayer Type</td>
            <td><input type='text' name='prayer_type' class='form-control'  required></td>
        </tr>
        <tr>
            <td>Time </td>
        ...
        <tr>
         ...
         <tr>
            <td>Prayed By</td>
            <td><input type='text' name='prayedby' class='form-control'  required></td>
        </tr>
        <tr>
            <td>Status</td>
...
<!--end of modal pop up-->
        ...
        <!-- Bootstrap 3.3.6 -->
                ...
                <script type="text/javascript" src="crudprayers.js"></script>
