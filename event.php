...
<p align="right">
                        ...
                        <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal" name="btn-update" id="btn-update">ADD EVENT</button></p>
 ...
 <!--end of  new event button-->
                            ...
                            $stmt = $dbh->prepare("SELECT * FROM events ORDER BY event_idm DESC");
                            $stmt->execute();
                            while($row=$stmt->fetch(PDO::FETCH_ASSOC))
                            {
                                ?>
                                <tr>
                                <td><?php echo $row['event_idm']; ?></td>
                                ...
                                <td><?php echo $row['eposter']; ?></td>
                            
                                <td align="center">
                                <a id="<?php echo $row['event_idm']; ?>" class="edit-link" href="#" title="Edit">
                                <img src="edit.png" width="20px" />
                                </a></td>
                                <td align="center"><a id="<?php echo $row['event_idm']; ?>" class="delete-link" href="#" title="Delete">
...
<!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <table class='table table-bordered table-responsive'>
        ...
        <tr>
            <td>Event Venue</td>
            <td><input type='text' name='evenue' class='form-control'  required></td>
        </tr>
        <tr>
            <td>Time From</td>
            <td><input type='text' name='tfrom' class='form-control'  required></td>
        </tr>
        <tr>
            <td>Time To</td>
            <td><input type='text' name='tto' class='form-control'  required></td>
        </tr>
        <tr>
            <td>Description</td>
